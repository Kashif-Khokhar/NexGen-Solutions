        ...
        <div className="pt-32 pb-24 px-[10%] font-jakarta relative z-10">
            <div className="max-w-4xl mx-auto">
                ...
                <h1 className="text-4xl md:text-6xl font-extrabold text-white mb-8 tracking-tight">
                    Pioneering the <span className="text-primary text-glow">Next Generation</span> of Digital Solutions
                </h1>
                ...
                <div className="glass rounded-[2.5rem] p-12 text-white border-white/5 shadow-2xl shadow-primary/5">
                    <h2 className="text-3xl font-bold mb-8 text-center text-balance">The NexGen Core Values</h2>
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
                        <div className="text-center">
                            <div className="text-primary text-3xl font-bold mb-2 text-glow">01</div>
                            <h4 className="font-bold mb-2 text-white">Excellence</h4>
                            <p className="text-neutral-400 text-sm">Never settling for 'good enough'.</p>
                        </div>
                        <div className="text-center">
                            <div className="text-primary text-3xl font-bold mb-2 text-glow">02</div>
                            <h4 className="font-bold mb-2 text-white">Innovation</h4>
                            <p className="text-neutral-400 text-sm">Constantly pushing technical boundaries.</p>
                        </div>
                        <div className="text-center">
                            <div className="text-primary text-3xl font-bold mb-2 text-glow">03</div>
                            <h4 className="font-bold mb-2 text-white">Integrity</h4>
                            <p className="text-neutral-400 text-sm">Building trust through transparency.</p>
                        </div>
                    </div>
                </div>
            </div>
